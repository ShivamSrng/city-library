    ...
    <>
      <div className={styles.loginPageContainer}>
        <div className={styles.imageContainer}>
          <Image className={styles.image} src={'/gifs/frequent_borrowers_branch_admin.gif'} alt="Admin" layout={'responsive'} width={50} height={50} />
        </div>
        <form className={styles.formContainer} onSubmit={
              async (event) => {
                ...
                const dynamicapi = 'http://localhost:8000/cityLibrary/admin/mostFrequentBorrowers/' +  limit + '/' + branchname
                ...
                content += "<h1 style='font-size: 2rem'>Most Frequency Borrowers of Branch: '" + branchname +"'</h1>"
                ...
                {
                  content += "<p>Failed to fetch the most frequent borrowers' data for the provided branch.</p>";
                }
          ...
          <div className={styles.placeHolder}>
            <label className={styles.label} htmlFor="username">Limit: </label>
            <input className={styles.input} type="text" id="limit" name="username" required/>
          </div>

          <div className={styles.placeHolder}>
            <label className={styles.label} htmlFor="username">Branch Name: </label>
...
export default mostFrequentBorrowerOfLibrary