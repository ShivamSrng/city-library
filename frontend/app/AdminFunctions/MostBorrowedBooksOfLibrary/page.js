...
const mostBorrowedBooksOfLibrary = ({username}) => {
  return (
    <>
      <div className={styles.loginPageContainer}>
        <div className={styles.imageContainer}>
          <Image className={styles.image} src={'/gifs/borrowed_book_library_admin.gif'} alt="Admin" layout={'responsive'} width={50} height={50} />
        </div>
        <form className={styles.formContainer} onSubmit={
              async (event) => {
                ...
                const dynamicapi = 'http://localhost:8000/cityLibrary/admin/mostBorrowedBooksInLibrary/' +  limit + '/' + libraryname
                ...
                content += "<h1 style='font-size: 2rem'>Most Borrowed Books of Library: '" + libraryname +"'</h1>"
...
export default mostBorrowedBooksOfLibrary