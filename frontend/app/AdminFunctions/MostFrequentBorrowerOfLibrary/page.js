    ...
    <>
      <div className={styles.loginPageContainer}>
        <div className={styles.imageContainer}>
          <Image className={styles.image} src={'/gifs/frequent_borrowers_library_admin.gif'} alt="Admin" layout={'responsive'} width={50} height={50} />
        </div>
        <form className={styles.formContainer} onSubmit={
              async (event) => {
                ...
                const dynamicapi = 'http://localhost:8000/cityLibrary/admin/mostFrequentBorrowersOfLibrary/' +  limit + '/' + libraryname
